...
window.KD_DEFAULTS = {
  version: 1,
  title: "Üniversite Kısayolları",
  kicker: "Bilgisayar Muhendisligi Bolumu",
  groups: [
    {
      name: "Ogrenci Sistemleri",
      color: "#1a3fd0",
      links: [
        { label: "Ogrenci Bilgi Sistemi (OBS)",            url: "https://ornek.edu.tr/obs",        tag: "giris" },
        { label: "Elektronik Belge Yonetim Sistemi (EBYS)", url: "https://ornek.edu.tr/ebys",       tag: "giris" },
        { label: "Uzaktan Egitim / LMS",                    url: "https://ornek.edu.tr/lms",        tag: "giris" },
        { label: "Ogrenci E-Posta",                         url: "https://ornek.edu.tr/eposta",     tag: "giris" },
        { label: "Kutuphane Hesabi",                        url: "https://ornek.edu.tr/kutuphane",  tag: "giris" }
      ]
    },
    {
      name: "Akademik",
      color: "#0a7f37",
      links: [
        { label: "Akademik Takvim",          url: "https://ornek.edu.tr/akademik-takvim",   tag: "pdf" },
        { label: "Ders Programi",            url: "https://ornek.edu.tr/ders-programi",     tag: "pdf" },
        { label: "Sinav Takvimi",            url: "https://ornek.edu.tr/sinav-takvimi",     tag: "pdf" },
        { label: "Vize / Final Programi",    url: "https://ornek.edu.tr/final-programi",    tag: "pdf" },
        { label: "Ders Icerikleri (AKTS)",  url: "https://ornek.edu.tr/akts",              tag: "katalog" },
        { label: "Devamsizlik / Not Girisi", url: "https://ornek.edu.tr/not-girisi",        tag: "giris" }
      ]
    },
    {
      name: "Bologna",
    ...
    },
    {
      ...
      links: [
        ...
        { label: "EBYS (Personel)",          url: "https://ornek.edu.tr/ebys",              tag: "giris" },
